...
<html>
    ...
    <body>
        ...
        <div class="main container indexContainer"
            <div class="row content main-container">
                ...
                <div class="col-sm-12 hidden-xs bs-example">
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        ...
                        ?>
                            <div class="carousel-item <?php if($n == 0 && $n < count($primeraFotoUltimosAnuncios)) {echo 'active';} ?>">
                                    <a class="linkAnuncios" href="./views/detallesAnuncio.php?idAnuncioSeleccionado=<?php echo $anunciosCarousel[$n]->idanuncio ?>">
                                        <img class="d-block fotosCarousel" src="<?php echo $primeraFotoUltimosAnuncios[$n]; ?>" alt="<?php echo $anunciosCarousel[$n]->nombreproducto; ?>" title="<?php echo $anunciosCarousel[$n]->nombreproducto; ?>">
                                    </a>
                ...
                <!--separador hr-->
                <hr id="sepAnuncio" class="col-xs-12 hidden-xs-down">
                <div class="well visible-xs col-xs-12">
                    <h3 class="col-xs-8 col-xs-offset-2">Categorias:</h3>
                    <ul class="pagination" id="pagination2">
                        <?php
                        $arrayCategorias=mostrarCategorias();
                        ?><li class="col-xs-8 col-xs-offset-2"><a href="./index.php?categoria=<?php echo null?>">Todo</a></li><?php
                        foreach ($arrayCategorias as $categoria){
                            ?>
                            <li class="col-xs-8 col-xs-offset-2"><a href="./index.php?categoria=<?php echo $categoria->categoria ?>"><?php echo $categoria->categoria ?></a></li>
                            <?php
                        }
                        ?>
                    </ul>
                ...
                <div class="subcontenido">
                    <div class="well col-xs-12 col-sm-8">
                        ...
                        foreach ($arrayAnuncios as $anuncio){
                            ?>
                            <div class="col-xs-6 col-sm-4 anuncioIndex">
                                <a class="linkAnuncios" href="./views/detallesAnuncio.php?idAnuncioSeleccionado=<?php echo $anuncio->idanuncio ?>">
                                    <?php
                                ...
                                <h4 class="hidden-xs"><?php echo $anuncio->nombreproducto ?></h4>
                                <p class="hidden-xs"><?php echo $anuncio->resumen ?></p>
                            </div>
                        <?php
                            }
                        ?>
                        ...
                        <div class="col-xs-10 col-sm-6 col-xs-offset-1 col-sm-offset-3">
                            <ul class="col-xs-12 pagination" id="paginasAnuncios">
                                <li id="botonAnterior"><a class="col-xs-6 col-sm-6 btn" id="linkAnterior" href="./index.php?pagina=0">&laquo;Anterior</a></li>
                                <li id="botonSiguiente"><a class="col-xs-6 col-sm-6 btn" id="linkSiguiente" href="./index.php?pagina=1">Siguiente&raquo;</a></li>
                            </ul>
                        </div>
                        <?php
                    ...
                    <!--barra lateral aside-->
                    <aside class="well col-sm-3 col-sm-offset-1 hidden-xs right lateral">
                        <h3>Categorias:</h3>
                        <ul class="pagination col-sm-12" id="pagination2">
                            <?php
                            $arrayCategorias=mostrarCategorias();
                            ?><li><a class="col-sm-12"" href="./index.php?categoria=<?php echo null?>">Todo</a></li><?php
                            foreach ($arrayCategorias as $categoria){
                                ?>
                                <li><a class="col-sm-12" href="./index.php?categoria=<?php echo $categoria->categoria ?>"><?php echo $categoria->categoria ?></a></li>
                                <?php
                            }
                            ?>
                        </ul>
                        ...
                        <a href="https://es-es.facebook.com/" target="_blank">
                            <img src="./img/Facebook-Color.png" alt="NoneAnuncios Facebook" title="NoneAnuncios Facebook" width="45" height="45"/>
                        </a>
                        <a href="https://twitter.com/?lang=es" target="_blank">
                            <img src="./img/Twitter-Color.png" alt="NoneAnuncios Twitter" title="NoneAnuncios Facebook" width="45" height="45"/>
                        </a>
                        <a href="https://es.linkedin.com/" target="_blank">
                            <img src="./img/LinkedIn-Color.png" alt="NoneAnuncios Linkedin" title="NoneAnuncios Facebook" width="45" height="45"/>
                        </a>
                    </aside>
                </div>
            </div>
